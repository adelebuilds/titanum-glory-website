...
const services = [
  {
    number: "01",
    icon: "idCard",
    title: "Malaysian Seafarer ID support",
    copy: "Assistance with documentation preparation and submission coordination.",
  },
  {
    number: "02",
    icon: "certificate",
    title: "Certificate of Recognition support",
    copy: "Professional support with documentation and application coordination.",
  },
  {
    number: "03",
    icon: "medical",
    title: "Medical booklet procurement support",
    copy: "Assistance coordinating the documentation required for procurement.",
  },
  {
    number: "04",
    icon: "education",
    title: "Education certificate recognition support",
    copy: "Support preparing and coordinating recognition documentation.",
  },
  {
    number: "05",
    icon: "stamp",
    title: "SID collection and CDC stamping support",
    copy: "Assistance with collection arrangements and stamping coordination.",
  },
  {
    number: "06",
    icon: "courier",
    title: "Courier coordination",
    copy: "Coordination of document dispatch and delivery arrangements.",
  },
];
